# Writing the modisa-jev modisa plugin
...
modisa plugin logs modisa-jev    # its stdout and stderr
modisa plugin run modisa-jev status '{"any":"params"}'
modisa plugin stop modisa-jev    # and plugin start modisa-jev
```
